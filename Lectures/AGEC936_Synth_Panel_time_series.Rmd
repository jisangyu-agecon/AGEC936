...
# Synthetic control methods
* Foundational piece: @abadie2010synthetic
...
* Innovations in inference techniques
  + Frequentist approaches: e.g. @li2020statistical, @chernozhukov2021exact
  + Bayesian approaches: e.g. @amjad2018robust, @goh2022synthetic
* Extension to disaggregated data: @arkhangelsky2021, @ben2021synthetic, @abadie2021penalized
* De-bias approach: @ben2021augmented
...
* Panel Vector Autoregression: Be aware of Nickell bias (Dissappears with large T, for short T, see Arellano-Bond-type first-differenced GMM estimators)
  + Some references: @holtz1988estimating, @abrigo2016estimation
