...
* Presentation/Referee report (5 page max): Choose an empirical paper that utilizes panel data and does a causal analysis based on panel data approaches. Choose from major economics or agricultural economics journals (limit the time period to post-2010). Please submit the citation of the paper of your choice by **11$^{th}$ of March**. Your referee report is due **25$^{th}$ of March**. Your referee report should contain
