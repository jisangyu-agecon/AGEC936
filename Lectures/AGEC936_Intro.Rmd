...
Nonparametric approaches (Kernel density estimation) or OLS estimation with (high-order) polynomials and interaction terms are often used. @lee2010regression is a good review article on RDD (See @filmer2011does or @pan2018agricultural for an example).
