...
* Weaker identifying assumption than FE/LSDV: $E(u_{it}|d_{it}, d_{it-1})=0$
...
- Let's start with some obvious ones:
  ...
  $$
    ...
    + *Possible solution?: Correlated Random Effects if you have both* **time-variant** *and* **time-invariant** *covariates (but different identifying assumption)*
...
# Other empirical issues in Panel analyses (which we will not cover)
