...
* Denote $y$ as the outcome, $d$ as the treatment, $x$ as the observable control, and $w$ as the unobservable confounder (assume the within transformation). Here is my attempt on drawing DAG for this problem (Full disclosure -- I am not a DAG expert and this needs some verifications):
...
* Again, an attempt to draw a DAG to show the IV approach can work (Full disclosure -- I am not a DAG expert and this needs some verifications):
